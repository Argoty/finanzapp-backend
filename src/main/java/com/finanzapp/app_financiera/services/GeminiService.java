...
public class GeminiService {
    ...
    @Autowired
    public GeminiService(RecordRepository rr, BudgetService bs, PlannedPaymentRepository ppr, DebtRepository dr, SavingRepository sr) {
        recordRepository = rr;
        budgetService = bs;
    ...
    public String handleGeminiRequest(int userId, String userPrompt) {
        ...
        if (nro == 1) {
            ...
            datosDeBD = "Presupuestos del usuario: " + gson.toJson(budgetService.getAllBudgetsStatus(userId, null));
        }else if (nro == 5) {
